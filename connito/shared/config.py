...
class CheckpointCfg(BaseConfig):
    ...
    # Legacy compatibility knob. Miner checkpoint downloads pull all shards
    # from Hugging Face one-by-one rather than parallel fan-out, but older
    # configs may still include this field.
