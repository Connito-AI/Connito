...
class Round:
    ...
    # The expert shard the round is scored against: vanilla backbone plus
    # this file *is* the base model. None on a cold start, where the base
    # is the pretrained backbone alone.
    base_shard: Path | None
    ...
    def freeze(
        ...
        *,
        ...
        logger.info(
            ...
            base_shard=str(base_shard) if base_shard else None,
        )
    ...
    def _journal_snapshot_locked(self) -> dict | None:
        ...
        return {
            ...
            "seed": str(self.seed),
            "base_shard": str(self.base_shard) if self.base_shard else "",
            "finalized": False,
        }
